            ...
            >
                ...
                <div className="flex flex-col md:flex-row justify-around">
                    ...
                    >
                        ...
                        <div className="text-2xl font-bold text-blue-500">{property.rates.weekly ? `$${property.rates.weekly}` : (<FaTimes className="text-red-700" />)}</div>
                    </div>
                    <div className="flex items-center justify-center mb-4 pb-4 md:pb-0">
                        <div className="text-gray-500 mr-2 font-bold">Monthly</div>
                        <div className="text-2xl font-bold text-blue-500">{property.rates.monthly ? `$${property.rates.monthly}` : (<FaTimes className="text-red-700" />)}</div>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md mt-6">
                ...
                >
                    {property.amenities.map((amenity, index) => (<li key={index}>
                        <FaCheck className="inline-block text-green-700 mr-2" /> {amenity}
                    </li>))}
                </ul>
            </div>
            {/* <!-- Map --> */}
